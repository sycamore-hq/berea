...
function memory_note_item(n) {
  ...
  return "<li><strong>" + (Melange__Html.esc(n.note_title) + ("</strong> <code>" + (Melange__Html.esc(n.note_path) + ("</code>\n<span class=\"muted\">" + (Melange__Html.esc(Melange__Memory_ml.kind_to_string(n.note_kind)) + (" \xc2\xb7 " + (Melange__Html.esc(Melange__Memory_ml.status_label(n.note_status)) + (" \xc2\xb7 " + (Melange__Html.esc(s !== undefined ? s : "") + ("</span>\n<p>" + (Melange__Html.esc(note_excerpt(n.note_body)) + "</p></li>")))))))))));
}
