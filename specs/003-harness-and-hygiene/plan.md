...
- The local switch is ocaml 5.5.1, dune 3.24.2, melange 7.0.1-55,
  ocamlformat 0.29.0. Cloud / CI opam is 2.5.x (2.5.2 today);
  ...
  `dune-project`. The exact 5.5.1 pin and the 5.5.1 `_generated/`
  proof are `004-ocaml-55`.
